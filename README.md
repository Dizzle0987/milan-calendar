...
Ogni conferma riceve un punteggio verificabile: 100 per una pagina ufficiale della singola partita, 95 per un EPG ufficiale, 90 per due guide indipendenti concordi, 85 per una guida affidabile sostenuta da una conferma ufficiale forte dei diritti e 70 per una sola guida. In Italia vengono conservate le opzioni confermate, incluse Sky/NOW quando applicabili. All'estero viene pubblicata **solo** un'alternativa gratuita con confidenza almeno 85; negli altri casi appare `🌍 In chiaro all'estero — Da confermare`. Un broadcaster estero a pagamento può essere conservato nei metadati di debug, ma non viene proposto nelle note del calendario.
